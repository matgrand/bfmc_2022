...
STEER_NOSIE_STDS_DEG = [0, 5, 10, 15, 20, 25, 30]
...
for STEER_NOISE_STD_DEG in STEER_NOSIE_STDS_DEG:
    ...
    STEER_NOISE_STD = np.deg2rad(STEER_NOISE_STD_DEG) # [rad] noise in the steering angle
    ...
    while not rospy.is_shutdown():
        ...
        print(f'NOISE: {STEER_NOISE_STD_DEG}')
