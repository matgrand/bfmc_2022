...
class sonarNODE():
    ...
    def _getting(self):
        ...
        while not rospy.is_shutdown() :
            ...
            while not (center_done and left_done and right_done):
                curr_time = time.time()
                ...
                if gpio.input(self.echo_right) == 0 and right_flag and not right_done:
                    ...
                    right_done = True
                if curr_time - start_time > self.max_train_pulse_time and not center_flag and not left_flag and not right_flag:
